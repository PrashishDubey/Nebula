...
@section('content')
    <section>
        <div class="container flame">
            <div class="col-4 mt-5 d-flex">
                <h1>Welcome to our shop</h1>
            </div>
            <p class="col-6 d-flex">
                Welcome visitors to your site with a short, engaging introduction.
                This is a great place to introduce your business, your products, and
            </p>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card text-dark card-has-bg click-col"
                        style="background-image: url('{{ asset('img/dress.webp') }}');">
                        <div class="card-img-overlay d-flex flex-column">
                            <div class="card-bodys">
                                <small class="card-meta mb-2">Party Time</small>
                                <h4 class="card-title mt-0">
                                    <a class="text-dark" href="">Dress Lorem Ipsum Sit Amet Consectetur dipisi?</a>
                                </h4>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div class="card text-dark card-has-bg click-col"
                        style="background-image: url('{{ asset('img/dress2.jpeg') }}');">
                        <div class="card-img-overlay d-flex flex-column">
                            <div class="card-bodys">
                                <small class="card-meta mb-2">Feel Free</small>
                                <h4 class="card-title mt-0">
                                    <a class="text-dark" href="">
                                        Inner Lorem Ipsum Sit Amet Consectetur dipisi?</a>
                                </h4>
                                <small><i class="far fa-clock"></i> October 15, 2020</small>
                            </div>
                        </div>
                ...
                <span class="col-sm-12 col-md-6 col-lg-4 mb-4">
                    <div>
                        <div class="banner-image">
                            <div class="media-wrapper">
                                <img class="editing" src="{{ asset('img/omg1.jpg') }}" width="415.98" height="550" />
                            </div>
                        </div>
                    </div>
                </span>
    ...
    <section class="pt-5 pb-5" style="background-color: #e2a8bb">
        <div class="container">
            <div class="row">
                <div class="hyper col-12">
                    <h3 class="mb-3">
                        <strong style="font-family: Garamond">Trending Now </strong>
                    </h3>
                </div>
                <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs. 2400</h4>
                                                <p class="card-text">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs.1800</h4>
                                                <p class="card-text">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Aliquam!
                                                </p>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs.3250</h4>
                                                <p class="card-text">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Itaque.
                                                </p>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs.1975</h4>
                                                <p class="card-text">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Eaque!
                                                </p>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs.1250</h4>
                                                <p class="card-text">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing
                                                    elit. Sed.
                                                </p>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Rs.1875</h4>
                                                <p class="card-text">
    ...
    <section class="testimonial_area">
        <div class="container">
                    ...
                    <div class="carousel-item">
                        <div class="testimonial_content">
                            <p>
                                ...
                                organizational context, by defining needs enabling change in
                                an organizational context, by defining needs.
                            </p>
                            <div class="media">
            ...
            <ul class="indicators">
                <li data-target=".testimonial_slide" data-slide-to="0" class="testimonial_1">
                    <img src="http://themazine.com/html/kabbo/images/testimonial-2.jpg" alt="" />
                </li>
                <li data-target=".testimonial_slide" data-slide-to="1" class="testimonial_2">
                    <img src="http://themazine.com/html/kabbo/images/testimonial-3.jpg" alt="" />
                </li>
                <li data-target=".testimonial_slide" data-slide-to="2" class="testimonial_3">
                    <img src="http://themazine.com/html/kabbo/images/testimonial-4.jpg" alt="" />
                </li>
                <li data-target=".testimonial_slide" data-slide-to="3" class="testimonial_4">
    ...
    <section class="hero-banner1 py-5" style="background-color: #e2a8bb">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="banner-image">
                        <div class="media-wrapper">
                            <div class="z-3 position-absolute p-5 rounded-3">
                                <span>
                                    <img class="photo-box shadow-sm" src="{{ asset('img/desert-white-dress.jpg') }}"
                                        alt="" srcset="" /></span>
                            </div>
                            <img class="wraper shadow" src="{{ asset('img/red.jpg') }}" width="600" height="496" />
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="banner-content my-5">
                        <p style="display: inline-block">About NEBULA</p>
                        <br />
                        <h1 style="display: inline-block">Make your Own Style</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="donate-box">
        <div class="d-flex justify-content-between align-items-center gx-80 w-100 container">
            <div class="flex-column text-white w-75">
                <h2 class="heading">Seasonal Sale</h2>
                <p class="headings fw-dark mt-24 mt-sm-12 clamp-2">
                    Limited Supply
                </p>
            </div>
